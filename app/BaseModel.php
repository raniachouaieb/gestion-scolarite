...
class BaseModel extends Model
{
    ...
    {
        if ($this->create_user) {
            $this->update_user = Auth::guard('admin')->user()->id;
        } else {
            $this->create_user =Auth::guard('admin')->user()->id;
        }
    ...
    {
        return $this->belongsTo(Admin::class,'create_user','id');
    }

    public function author()
    {
        return $this->belongsTo("App\Models\Admin", "create_user", "id")->withDefault();
    }
