...
<div>
    ...
    <script src="{{URL::asset('assets/js/jquery-1.11.1.js')}} defer"></script>
    <script src="{{URL::asset('assets/js/jquery-3.6.0.js')}}"></script>
    <script src="{{ URL::asset('assets/js/jquery.repeater.js') }}" type="text/javascript"></script>
