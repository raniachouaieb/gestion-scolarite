                            ...
                            <div class="repeater clearfix">
                                <div data-repeater-list="outer-list-lundi" style=" padding: 0px 50px; ">
                                    @if (isset($row->monday))
                                        @foreach(json_decode($row->monday, true) as $member)
                                            <div data-repeater-item class="mt-repeater-item"
                                                ...
                                                <div class="row"
                                                     style="margin-top: 15px;margin-bottom: 15px;color: #fff;">
                                                    <div class="mt-repeater-input  col-md-12">
                                    ...
                                    <div data-repeater-item class="mt-repeater-item"
                                        ...
                                        <div class="row" style="margin-top: 15px;margin-bottom: 15px;color: #fff;">
                                            <div class="mt-repeater-input  col-md-12">
                                                <a data-repeater-delete
                                                   class="btn btn-danger mt-repeater-delete"
                                                   style="float: left;margin: 0 10px; ">
