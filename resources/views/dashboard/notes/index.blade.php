...
@section('scripts')
            ...
            <script type="text/javascript">
                ...
                $("button").click(function() {
                    ...
                    $("#portal2").hide();
                    $.ajax({
                        url: "{{ route('note.admin.loadmodules') }}/"+$button+'/'+$level_id ,
                        //data:{"class":$(this).val()},
                        method: 'GET',
                        success: function(data) {
                            ...
                            $( ".btn-check2" ).click(function() {
                                ...
                                if(classroom_id && level_id && matiere_id && trimestre){
                                    ...
                                    $("#portal2").hide();
                                    $.ajax({
                                        url:  '{{url('admin/note/loadNotes')}}/'+classroom_id+'/'+level_id+'/'+trimestre+'/'+matiere_id,
                                        type: "get",
